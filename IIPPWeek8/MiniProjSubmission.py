# http://www.codeskulptor.org/#user44_ri25KTyxjq_4.py
...
class Sprite:
    ...
    def collide(self, object):
        dist = math.sqrt((self.get_position()[0] - object.get_position()[0]) ** 2 +  (self.get_position()[1] - object.get_position()[1]) ** 2 )
        if dist >= (self.get_radius() + object.get_radius()):
            return False
        else:
            return True
